...
if __name__ == '__main__':
    test_synapse(ckpt="log/mcavm-unet-synapse/checkpoints/epoch=264-val_mean_dice=0.8624.ckpt")
    #test_acdc(ckpt="log/mcavm-unet-acdc/checkpoints/epoch=239-val_mean_dice=0.9279.ckpt")
